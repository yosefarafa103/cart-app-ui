            ...
            <div className="bg-[#f7f7f7] p-[10px] rounded-md">
              <div className="flex flex-col gap-2 items-center" key={el._id}>
                ...
                <button
                  ...
                  className="mt-2 p-4 py-2 border-solid border-[1px] border-[#ddd] font-semibold rounded-[50px]  bg-white"
                >
                  Buy This Product
                </button>
              </div>
              <div className="flex items-center mt-3 justify-between">
                ...
                <Link
                  to={`/product/${el?._id}`}
                  className="flex items-center cursor-pointer  min-w-[60px] px-2 py-1 rounded-md  justify-center bg-gray-200 gap-2"
                >
                  {el.comments.length}
